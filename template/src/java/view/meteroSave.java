 ...
 * @author Z00907
 */
public class meteroSave extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String timeBase = request.getParameter("timeBase"); //等级衡量时间
        String timeBaseUnit = request.getParameter("timeBaseUnit"); //等级衡量时间单位
        String operationLB = request.getParameter("operationLB"); //操作符(下限)
        String triggerPointLB = request.getParameter("triggerPointLB"); //触发条件(下限)
        String operationUB = request.getParameter("operationUB"); //操作符(上限)
        String triggerPointUB = request.getParameter("triggerPointUB"); //触发条件(上限)
        String measureUnit = request.getParameter("measureUnit"); //衡量基础单位
