                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li><i class="icon_documents_alt"></i>观测站新建</li>
                                </ol>
                            </div>
                        </div>
                        <div class="panel-content ">
                            <div class="panel-body">
                                <form id="addForm" class="form-horizontal " method="post"  >
                                    <input type="hidden" class="form-control" id="postType" name="postType" value="edit" disabled="disbled" >
                                    ...
                                    <div class="panel-content">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control m-bot15" id="observeSiteType" name="observeSiteType" disabled="disbled">
                                                    <option value=""></option>
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="observeSiteName" name="observeSiteName" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">经度</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="longitude" name="longitude" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">纬度</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="latitude" name="latitude" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">海拔高度</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="altitude" name="altitude" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">台站等级</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="stationLevel" name="stationLevel" disabled="disbled">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control m-bot15" id="evaluationFlag" name="evaluationFlag" disabled="disbled">
                                                    <option value=""></option>
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control m-bot15" id="status" name="status" disabled="disbled">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input id="validFrom" name="validFrom" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">有效时间(讫)</label>
                                            <div class="col-sm-2">
                                                <input id="validEnd" name="validEnd" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">中国天气网预报编码</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="weatherCNSiteId" name="weatherCNSiteId" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">预报替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="forecastAsite1" name="forecastAsite1" type="text" value=""  class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">预报替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="forecastAsite2" name="forecastAsite2" type="text" value="" class="form-control" disabled="disbled" >
                                            </div>
                                            <label class="col-sm-2 control-label">预报替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="forecastAsite3" name="forecastAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">摄氏温度标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="temperatureC" name="temperatureC" type="text" value=""  class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">摄氏温度替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="temperatureAsite1" name="temperatureAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">摄氏温度替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="temperatureAsite2" name="temperatureAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">摄氏温度替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="temperatureAsite3" name="temperatureAsite3" type="text" value=""  class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">风观测替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="windAsite1" name="windAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">风观测替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="windAsite2" name="windAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">风观测替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="windAsite3" name="windAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">向标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="windDirectionC" name="windDirectionC" type="text" value="" class="form-control" disabled="disbled"> 
                                            </div>
                                            <label class="col-sm-2 control-label">风力等级标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="windGradeC" name="windGradeC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">风速标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="windSpeedC" name="windSpeedC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">相对湿度标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="rhC" name="rhC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">相对湿度替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="rhAsite1" name="rhAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">相对湿度替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="rhAsite2" name="rhAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">相对湿度替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="rhAsite3" name="rhAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">能见度标示;负数表示不可用</label>
                                            <div class="col-sm-2">
                                                <input id="vibilityC" name="vibilityC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">能见度替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="vibilityAsite1" name="vibilityAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">能见度替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="vibilityAsite2" name="vibilityAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">能见度替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="vibilityAsite3" name="vibilityAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">一小时累积降水标示</label>
                                            <div class="col-sm-2">
                                                <input id="precipitation1C" name="precipitation1C" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">六小时累积降水标示</label>
                                            <div class="col-sm-2">
                                                <input id="precipitation6C" name="precipitation6C" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">十二小时累积降水标示</label>
                                            <div class="col-sm-2">
                                                <input id="precipitation12C" name="precipitation12C" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">二十四小时累积降水标示</label>
                                            <div class="col-sm-2">
                                                <input id="precipitation24C" name="precipitation24C" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">降水量替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="precipitationAsite1" name="precipitationAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">降水量替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="precipitationAsite2" name="precipitationAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">降水量替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="precipitationAsite3" name="precipitationAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">大气压力标示</label>
                                            <div class="col-sm-2">
                                                <input id="atmoPreesureC" name="atmoPreesureC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">大气压力替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="atmoPreesureAsite1" name="atmoPreesureAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">大气压力替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="atmoPreesureAsite2" name="atmoPreesureAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">大气压力替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="atmoPreesureAsite3" name="atmoPreesureAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">蒸发量标示</label>
                                            <div class="col-sm-2">
                                                <input id="evaporationC" name="evaporationC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">蒸发量替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="evaporationAsite1" name="evaporationAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">蒸发量替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="evaporationAsite2" name="evaporationAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">蒸发量替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="evaporationAsite3" name="evaporationAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">日照时长标示</label>
                                            <div class="col-sm-2">
                                                <input id="sunHourC" name="sunHourC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">日照时长替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="sunHourAsite1" name="sunHourAsite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">日照时长替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="sunHourAsite2" name="sunHourAsite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">日照时长替代站3</label>
                                            <div class="col-sm-2">
                                                <input id="sunHourAsite3" name="sunHourAsite3" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">0CM地温摄氏标示</label>
                                            <div class="col-sm-2">
                                                <input id="zeroCmGrandTempC" name="zeroCmGrandTempC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">天气现象标示</label>
                                            <div class="col-sm-2">
                                                <input id="phenomenaC" name="phenomenaC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">空气质量指标标示</label>
                                            <div class="col-sm-2">
                                                <input id="aqiC" name="aqiC" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">PM10标示</label>
                                            <div class="col-sm-2">
                                                <input id="pm10C" name="pm10C" type="text" value="" class="form-control"disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">PM2.5标示</label>
                                            <div class="col-sm-2">
                                                <input id="pm25C" name="pm25C" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">空气质量替代站1</label>
                                            <div class="col-sm-2">
                                                <input id="aqSite1" name="aqSite1" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
                                            <label class="col-sm-2 control-label">空气质量替代站2</label>
                                            <div class="col-sm-2">
                                                <input id="aqSite2" name="aqSite2" type="text" value="" class="form-control" disabled="disbled">
                                            </div>
