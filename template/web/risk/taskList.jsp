                ...
                $.ajax({
                    ...
                    success: function (JData) {
                        ...
                        $("select[name=operation]").change(function () {
                            if ($(this).val() == "E") {
                                window.location.href = "input.jsp?key=" + $(this).attr("key");
                            } else if ($(this).val() == "V") {
                               alert("地圖");
                            } else {
                                $.ajax({
                                    url: "../taskListSave",
                                    data: {type: $(this).val(), key: $(this).attr("key")},
                                    type: "POST",
                                    //   dataType: "json",
                                    success: function (JData) {
                                        alert(JData)
