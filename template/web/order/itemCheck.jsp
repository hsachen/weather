...
<section class="wrapper">     
    <div class="panel panel-info">
        <div class="panel-heading"><span style="font-size:36px;">项目管理</span><span style="font-size:24px;">&nbsp; 项目审核</span></div>
        <div class="panel-content ">
            <div class="panel-body">           
                <form id="checkForm" class="form-horizontal " method="post">
                      <input type="hidden" class="form-control" id="postType" name="postType" value="check" >
            ...
            <div class="form-group">
                ...
                <a class="btn btn-default"  title="审核通过" id="add">审核通过</a>
            </div>
